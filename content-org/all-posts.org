...
:PROPERTIES:
:EXPORT_HUGO_SECTION: project/aci_mri_prediction_2021-04-27
:EXPORT_FILE_NAME: index
:EXPORT_AUTHOR: Helen McCarthy, Iain McCall, Claire Mennan, Mike Williams, James Richardson, Sally Roberts
:EXPORT_HUGO_FRONT_MATTER_FORMAT: yaml
:END:
...
Instead of following patients up for 10 years in person, an MRI at 1 year could predict how well those patients would do with this treatment, which could be a huge cost-saving in running such trials. ([[https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6081761/][McCarthy et al (2018) Orthop J Sports Med. 2018 Aug; 6(8): 325967118788280]])
